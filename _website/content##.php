	...
	<div class="g-header">
		<div class="container">
			<div class="HeaderDivForMobile">
				...
				<div class="col-sm-7 MobilePosition1">
					<a href="<?php echo href('1');?>" class="Logo g-logo"></a>
							...
							<div class="HeaderFilter">
								<!-- <div class="btn-group">
									...
									<ul class="dropdown-menu CategoriesDropDown">
										<li data-id="0" data-title="<?=l("allcategories")?>" data-slug="home">
											<a href="javascript:;"><i class="fa fa-list"></i><?=l("allcategories")?></a>
										</li>
								...
								<button type="button" class="SearchButton gsearchButton"><i class="fa fa-map-marker"></i> <?=l("mapstext")?></button>
							</div>
				    ...
				    //     		$slug = @$real_url[2]."/".@$real_url[3];
								$slug ="";
								?>
								// var id = $("[data-slug='<?=$slug?>']").attr("data-id");
								// var title = $("[data-slug='<?=$slug?>']").attr("data-title");
								...
								// 	var title2 = li.getAttribute("data-title");

								// 	document.getElementsByClassName("CategoriesSelect")[0].innerHTML = title2+" <span class=\"caret pull-right\"></span>";
								// 	document.getElementsByClassName("category_s")[0].value = id2;
								// }
							</script>
	                </form>
				</div>
				<div class="col-sm-5 text-right padding-right:0">
					<!-- <div class="g-HamburgMenu" data-status="closed"></div> 
					<div class="g-new-style-menu">
						<ul><?php echo main_menu();?></ul>
					</div> -->
					<script type="text/javascript">
						$(".g-HamburgMenu").click(function(){
							var status = $(this).attr("data-status");
							if(status=="closed"){
								$(this).attr("data-status", "opened");
								$(this).addClass("g-opened-burger");
								$(".g-new-style-menu").slideDown();
							}else{
								$(this).attr("data-status", "closed");
								$(this).removeClass("g-opened-burger");
								$(".g-new-style-menu").slideUp();
							}
						});
					</script>
