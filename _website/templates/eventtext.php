<?php defined('DIR') OR exit; global $storage; ?>
        ...
        <article id="page" class="wrapper fix">
            ...
            <?php endif ?>
                ...
                ?>
                    <div><?php echo l('adress') ?>: <a href="<?php echo $storage->section['field1'] ?>" target="_blank"><?php echo rtrim(str_replace("https://", "".$www."", $storage->section['field1']), "/") ?></a></div>
                <?php endif ?>
