...
// ADD TOPIC
                    ...
                    if (!empty($languages))
                    {
						...
						$expiretime = isset($_POST["expiretime"]) ? $_POST["expiretime"] : date("H:i:s");
						$_POST["expiredate"] = isset($_POST["expiredate"]) ? $_POST["expiredate"] : date("Y-m-d");
...
// ADD TOPIC
					...
					$_POST["expiredate"] .= ' ' . $_POST["expiretime"];
					$_POST["visibility"] = (isset($_POST["visibility"])) ? 1 : 0;
					$_POST["homepage"] = (isset($_POST["homepage"])) ? 1 : 0;
...
//  update identically
    	            ...
    	            elseif($tabstop == 'files')
   	                	redirect(ahref(array('files', '', $this->route[2], $this->route[2])));
    ...
    function catalog()
	{
        switch ($this->route[1]):
            case 'show':
                ...
                $sql = db_fetch_all("SELECT * FROM `".c("table.catalogs")."` WHERE `deleted` = 0 and `language` = '".l()."'{$homepage} and `menuid` = {$this->route[2]} AND `title` LIKE '%" . get('srch', '') . "%' ORDER BY `position` limit " . get('start', 0) . ', 5000;');
            ...
            case 'add':
                if (!empty($_POST['title'])):
					...
					$_POST["visibility"] = (isset($_POST["visibility"])) ? 1 : 0;
					$_POST["recommended"] = (isset($_POST["recommended"])) ? 1 : 0;
					$_POST["popu"] = (isset($_POST["popu"])) ? 1 : 0;

					$additionalservices = $_POST['additionalservices'];
					$airbnb = $_POST['airbnb'];
					$airbnb = $_POST['youtube'];
					...
					$addresslists = $_POST['addresslists'];
					$website = $_POST['website'];
					$mail = $_POST['mail'];
					$phone = $_POST['phone'];	
												
					$_POST["visa"] = (isset($_POST["visa"])) ? 1 : 0;
					$_POST["cash"] = (isset($_POST["cash"])) ? 1 : 0;
					$_POST["wifi"] = (isset($_POST["wifi"])) ? 1 : 0;
					$_POST["kitchentype1"] = (isset($_POST["kitchentype1"])) ? 1 : 0;
					$_POST["kitchentype2"] = (isset($_POST["kitchentype2"])) ? 1 : 0;
					$_POST["kitchentype3"] = (isset($_POST["kitchentype3"])) ? 1 : 0;
					$_POST["kitchentype4"] = (isset($_POST["kitchentype4"])) ? 1 : 0;
					$_POST["kitchentype5"] = (isset($_POST["kitchentype5"])) ? 1 : 0;
					$_POST["kitchentype6"] = (isset($_POST["kitchentype6"])) ? 1 : 0;
					$_POST["kitchentype7"] = (isset($_POST["kitchentype7"])) ? 1 : 0;
					$_POST["kitchentype8"] = (isset($_POST["kitchentype8"])) ? 1 : 0;
					$_POST["kitchentype9"] = (isset($_POST["kitchentype9"])) ? 1 : 0;
					$_POST["kitchentype10"] = (isset($_POST["kitchentype10"])) ? 1 : 0;
					$_POST["breakfast"] = (isset($_POST["breakfast"])) ? 1 : 0;
					$_POST["parking"] = (isset($_POST["parking"])) ? 1 : 0;
					$_POST["animals"] = (isset($_POST["animals"])) ? 1 : 0;
					$_POST["transfer"] = (isset($_POST["transfer"])) ? 1 : 0;
					$_POST["pool"] = (isset($_POST["pool"])) ? 1 : 0;
					$_POST["tennis"] = (isset($_POST["tennis"])) ? 1 : 0;
					$_POST["casino"] = (isset($_POST["casino"])) ? 1 : 0;
					$_POST["nightclub"] = (isset($_POST["nightclub"])) ? 1 : 0;
					$_POST["restaruant"] = (isset($_POST["restaruant"])) ? 1 : 0;
					$_POST["cafe"] = (isset($_POST["cafe"])) ? 1 : 0;
					$_POST["buffet"] = (isset($_POST["buffet"])) ? 1 : 0;
					$_POST["bar"] = (isset($_POST["bar"])) ? 1 : 0;
					$_POST["fitnes"] = (isset($_POST["fitnes"])) ? 1 : 0;
					$_POST["sauna"] = (isset($_POST["sauna"])) ? 1 : 0;
					$_POST["hamami"] = (isset($_POST["hamami"])) ? 1 : 0;
					$_POST["massage"] = (isset($_POST["massage"])) ? 1 : 0;
					$_POST["openpond"] = (isset($_POST["openpond"])) ? 1 : 0;
					$_POST["closedpond"] = (isset($_POST["closedpond"])) ? 1 : 0;
					$_POST["spa"] = (isset($_POST["spa"])) ? 1 : 0;
					$_POST["solarium"] = (isset($_POST["solarium"])) ? 1 : 0;
					$_POST["pwd"] = (isset($_POST["pwd"])) ? 1 : 0;
					$_POST["proom"] = (isset($_POST["proom"])) ? 1 : 0;
					$_POST["live"] = (isset($_POST["live"])) ? 1 : 0;
					$_POST["music"] = (isset($_POST["music"])) ? 1 : 0;
					$_POST["pandus"] = (isset($_POST["pandus"])) ? 1 : 0;
					$_POST["lounch"] = (isset($_POST["lounch"])) ? 1 : 0;
					$_POST["furshet"] = (isset($_POST["furshet"])) ? 1 : 0;
					$_POST["onlysummer"] = (isset($_POST["onlysummer"])) ? 1 : 0;
					$_POST["deliveri"] = (isset($_POST["deliveri"])) ? 1 : 0;
            ...
            case 'edit':
                ...
                if (!empty($_POST['title'])):
                    ...
                    $data = array(
						...
						'image1' => $_POST['image1'],						
						'deliveri' => $_POST['deliveri'],
						'onlysummer' => $_POST['onlysummer'],
						'furshet' => $_POST['furshet'],
						'lounch' => $_POST['lounch'],
						'pandus' => $_POST['pandus'],
						'music' => $_POST['music'],
						'live' => $_POST['live'],
						...
						'spa' => $_POST['spa'],
						'closedpond' => $_POST['closedpond'],
						'openpond' => $_POST['openpond'],
						...
						'buffet' => $_POST['buffet'],
						'cafe' => $_POST['cafe'],
						'restaruant' => $_POST['restaruant'],
						'nightclub' => $_POST['nightclub'],
						'casino' => $_POST['casino'],
						'tennis' => $_POST['tennis'],
						'pool' => $_POST['pool'],
						...
						'kitchentype10' => $_POST['kitchentype10'],
						'kitchentype9' => $_POST['kitchentype9'],
						'kitchentype8' => $_POST['kitchentype8'],
						'kitchentype7' => $_POST['kitchentype7'],
						'kitchentype6' => $_POST['kitchentype6'],
						'kitchentype5' => $_POST['kitchentype5'],
						'kitchentype4' => $_POST['kitchentype4'],
						'kitchentype3' => $_POST['kitchentype3'],
						'kitchentype2' => $_POST['kitchentype2'],
						'kitchentype1' => $_POST['kitchentype1'],
						'visa' => $_POST['visa'],
						'cash' => $_POST['cash'],
						'wifi' => $_POST['wifi'],						
						'addresslists' => $_POST['addresslists'],						
