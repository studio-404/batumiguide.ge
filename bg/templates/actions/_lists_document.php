...
?>
		<div id="title" class="fix">
			<div class="icon"><img src="bg/img/buttons/_question.png" width="16" height="16" alt="" /></div>
...
?>
					<ul id="page" class="fix left" style="width:720px; float: left;">
						<li><a href="<?php echo ahref(array($route[0], $route[1], $route[2]), array('start' => 0, 'srch' => get('srch',''), 'rec' => get('rec','')))?>"><img src="bg/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], $route[1], $route[2]), array('start' => 50 * ($j - 1), 'srch' => get('srch',''), 'rec' => get('rec','')))?>"><img src="bg/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
...
?>
						<li><a href="<?php echo ahref(array($route[0], $route[1], $route[2]), array('start' => 50 * ($k - 1), 'srch' => get('srch',''), 'rec' => get('rec','')))?>"><img src="bg/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], $route[1], $route[2]), array('start' => 50 * ($lastpage - 1), 'srch' => get('srch',''), 'rec' => get('rec','')))?>"><img src="bg/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
					<a href="<?php echo ahref(array($route[0], 'add', $route[2]));?>" class="button br" style="float: right"><?php echo a('add');?></a>
				</div>
			</div>
