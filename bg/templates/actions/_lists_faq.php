...
function _build_lists($parent, $order_by, $start = -1,$per_page)
{
    ...
    foreach ($results AS $result):
        $is_first = ($count == 1);
        $is_last = ($count >= $total);
        $arrow_up = $is_first ? '<img src="bg/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="javascript:pos(\'up\',\''.$result['id'].'\')"><img src="bg/img/buttons/icon_arrow_up_' . ($result['level'] > 1 ? 1 : 2) . '.png" class="star" title="' .  a('tt.moveup') . '" width="9" height="9" /></a>';
        $arrow_down = $is_last ? '<img src="bg/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="javascript:pos(\'down\',\''.$result['id'].'\')"><img src="bg/img/buttons/icon_arrow_down_' . ($result['level'] > 1 ? 1 : 2) . '.png" class="star" title="' .  a('tt.movedn') . '" width="9" height="9" /></a>';
