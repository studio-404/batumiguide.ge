...
?>
					<div class="<?php echo $class;?> fix">
						<div class="icon4"><img src="bg/img/buttons/<?php echo $fileicon;?>.png" width="16" height="16" alt="" /></div>									
						<div class="name4"><a href="<?php echo c('folders.backup') . $file;?>"><?php echo $filetitle; ?></a></div>									
															
						<div class="act2 fix">
							<a href="<?php echo c('folders.backup') . $file;?>"><img src="bg/img/buttons/icon_link.png" /></a>
<?php if($_SESSION['auth']["class"] == '0') { ?>
							<a href="javascript:del('<?php echo $file;?>', '<?php echo $file;?>');"><img src="bg/img/buttons/icon_delete.png" /></a>
<?php } ?>
						</div>
