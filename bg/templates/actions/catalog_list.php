...
<?php
	...
	if($total > 0) :
		foreach($catalogs as $catalog) :
			$is_first = ($cnt == 1);
			$is_last = ($cnt >= $total);
			$arrow_up = $is_first ? '<img src="bg/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="javascript:pos(\'up\',\''.$catalog['id'].'\')"><img src="bg/img/buttons/icon_arrow_up.png" alt="Move Up" title="Move Up" width="9" height="9" /></a>';
			$arrow_down = $is_last ? '<img src="bg/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="javascript:pos(\'down\',\''.$catalog['id'].'\')"><img src="bg/img/buttons/icon_arrow_down.png" alt="Move Down" title="Move Down" width="9" height="9" /></a>';
...
?>
					<div class="<?php echo $class;?> fix" id="div<?php echo $catalog["id"] ?>">
						<div class="check">
							<a href="javascript:chclick('<?php echo $catalog['id']; ?>');"><img src="bg/img/buttons/icon_<?php echo $ch;?>visible.png" class="star" title="<?php echo a('tt.visibility');?>" id="img_<?php echo $catalog['id'];?>" style="width:9px;height:9px;" /></a>
	...
	<?php echo mb_substr(href($pageid, array(), l(), $catalog["id"]), 0,84,'UTF-8') . ((mb_strlen(href($pageid, array(), l(), $catalog["id"]),'UTF-8')>84) ? '...' : '');?>
						...
						<div class="action fix">
							<a href="<?php echo ahref(array($route[0], 'edit', $catalog['id']));?>" title="<?php echo a('ql.edit');?>"><img src="bg/img/buttons/icon_edit.png" /></a>
							<a href="javascript:del(<?php echo $catalog['id'];?>, '<?php echo $catalog['title'];?>');" title="<?php echo a('ql.delete');?>"><img src="bg/img/buttons/icon_delete.png" /></a>
						</div>
...
?>
					<ul id="page" class="fix left" style="width:720px; float: left;">
						<li><a href="<?php echo ahref(array($route[0], 'show', $route[2]), $params) ?>"><img src="bg/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], 'show', $route[2]), $params) ?>"><img src="bg/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
...
?>
						<li><a href="<?php echo ahref(array($route[0], 'show', $route[2]), $params) ?>"><img src="bg/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], 'show', $route[2]), $params) ?>"><img src="bg/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
					<a href="<?php echo ahref(array($route[0], 'add', $route[2])) ;?>" class="button br" id="addcategory" style="float: right"><?php echo a("addcatalogitem");?></a>
				</div>
			</div>
