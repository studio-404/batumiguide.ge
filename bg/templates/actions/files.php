...
<?php
	...
	foreach($files as $file) :
        $is_first = ($count == 1);
        $is_last = ($count >= $total);
        $arrow_up = $is_first ? '<img src="bg/img/none.png" width="10" height="7" />' : '<a href="javascript:pos(\'up\',\''.$file['id'].'\')"><img src="bg/img/buttons/icon_arrow_up.png" class="star" title="' .  a('tt.moveup') . '" width="10" height="7" /></a>';
        $arrow_down = $is_last ? '<img src="bg/img/none.png" width="10" height="7" />' : '<a href="javascript:pos(\'down\',\''.$file['id'].'\')"><img src="bg/img/buttons/icon_arrow_down.png" class="star" title="' .  a('tt.movedn') . '" width="10" height="7" /></a>';
...
?>
					<div class="<?php echo $class;?> fix" id="div<?php echo $file["id"];?>">
						<ul class="action fix">
                        	<a href="<?php echo href($route[1]) ?>" target="_blank"><img src="bg/img/buttons/icon_preview.png" class="star" title="<?php echo a('ql.preview');?>" /></a>
						...
						<div class="icon"><img src="bg/img/icons/<?php echo $ext;?>.gif" /></div>
