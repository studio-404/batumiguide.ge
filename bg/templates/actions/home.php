			...
			<div class="smartblock fix">
				<div class="content br">
                        ...
                        <div class="list<?php echo $index;?> fix" style=" <?php echo ($index=='4') ? 'border:1px solid #e1e1e1;' : '';?>">
                            ...
                            <div class="smicon"><a href="<?php echo ahref(array('sitemap', 'show', $cat['id']));?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>					
						<?php
                            endforeach;
                        ?>
			...
			<div class="smartblock fix" style="width:34%">
				<div class="content br">
                        ...
                        <div class="list<?php echo $index;?> fix" style=" <?php echo ($index=='4') ? 'border:1px solid #e1e1e1;' : '';?>;">
                            ...
                            <div class="smicon"><a href="<?php echo ahref(array($act ,'show', $cat['id']));?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>
                        <?php
                                }
                            endforeach;
			...
			<div class="smartblock fix">
				<div class="content br">
                        ...
                        <div class="list<?php echo $index;?> fix" style=" <?php echo ($index=='4') ? 'border:1px solid #e1e1e1;' : '';?>">
                            ...
                            <div class="smicon"><a href="<?php echo ahref(array($cat["type"] ,'show', $cat['id']));?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>
						<?php
                                }
                            endforeach;
			...
			<div class="smartblock fix">
				<div class="content br">
                        ...
                        <div class="list<?php echo $index;?> fix" style=" <?php echo ($index=='4') ? 'border:1px solid #e1e1e1;' : '';?>">
                            ...
                            <div class="smicon"><a href="<?php echo ahref(array('banners' ,'show', $cat['id']));?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>
						<?php
                            endforeach;
                        ?>
			...
			<div class="smartblock fix" style="width:34%">
				<div class="content br">
                        ...
                        <div class="list4 fix" style="border:1px solid #e1e1e1;">
                            ...
                            <div class="smicon"><a href="<?php echo ahref(array('users')) ?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>						
                        <div class="list3 fix">
							<div class="name left"><a href="<?php echo ahref(array('users', 'add')) ?>"><span class="grey b"><?php echo a("newuser"); ?></span></a></div>							
                            <div class="smicon"><a href="<?php echo ahref(array('users', 'add')) ?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>
						<?php
                        ...
                        <div class="list4 fix" style="border:1px solid #e1e1e1;">
                            ...
                            <div class="smicon"><a href="<?php echo ahref(array('userrights')) ?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>					
					<?php
                            }
                    ?>                        
			...
			<div class="smartblock fix">
				<div class="content br">
                    ...
                    <div class="list4 fix" style="border:1px solid #e1e1e1;">
                        ...
                        <div class="smicon"><a href="<?php echo ahref(array('settings')) ?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                    </div>
                    <?php
                        }
                    ...
                    <div class="list3 fix">
                        ...
                        <div class="smicon"><a href="<?php echo ahref(array('langdata')) ?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                    </div>
                    <?php
                        }
                    ?>
