...
<?php $ulink = ($route[1]=="add") ? ahref(array($route[0], 'add', $menuid)) : ahref(array($route[0], 'edit', $id)); ?>
                <form id="catform" name="catform" method="post" action="<?php echo $ulink;?>">
                    ...
                    <?php if ($menuid == 13): ?>
                        <div class="list2 fix">
                            <div class="name">სათაურის გამოჩენა: <span class="star">*</span></div>
                            <input type="checkbox" name="show_title" class="inp-check"<?php echo (($route[1]=='edit')&&($show_title==0)) ? '' : ' checked' ?> />
                        </div>
                    <?php endif ?>
                        ...
                        <div class="list2 fix">
                            <div class="name">ბანერის ტიპი: <span class="star">*</span></div>
                            <select name="htmlstring" class="inp-small">
                                <option value="1" <?=(isset($htmlstring) && $htmlstring==1)? 'selected="selected"' : ''?>>ფოტო</option>
                                <option value="2" <?=(isset($htmlstring) && $htmlstring==2)? 'selected="selected"' : ''?>>Html</option>
                            </select>
                        </div>

                        <div class="list fix">
                            <div class="name">ფოტო / html: <span class="star">*</span></div>
                        ...
                        <div class="list fix">
                            <div class="name">ფოტო / html (Mobile): <span class="star">*</span></div>
                            <input type="text" id="image2" name="image2" value="<?php echo ($route[1]=='edit') ? $image2 : '' ?>" class="inp" style="width:500px;" />
                            <a href="#" class="popup button br" data-browse="image2"><?php echo a('browse') ?></a>
                        </div>
