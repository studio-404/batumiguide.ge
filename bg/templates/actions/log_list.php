...
?>
				<div id="bottom" class="fix">
					<ul id="page" class="fix left" style="width:720px; float: left;">
						<li><a href="<?php echo ahref('log', '', array('start' => 0));?>"><img src="bg/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref('log', '', array('start' => 50 * ($j - 1)));?>"><img src="bg/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
...
?>
						<li><a href="<?php echo ahref('log', '', array('start' => 50 * ($k - 1)));?>"><img src="bg/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref('log', '', array('start' => 50 * ($lastpage - 1)));?>"><img src="bg/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
					<a href="javascript:clear('<?php echo a('clearlogquestion');?>');" class="button br" style="float: right"><?php echo a("clearlog");?></a>
				</div>					
			</div>		
