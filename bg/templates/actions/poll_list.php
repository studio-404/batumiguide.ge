...
<?php
	...
	if(count($polls) > 0) :
		foreach($polls as $poll) :
			$is_first = ($count == 1);
			$is_last = ($count >= $total);
			$arrow_up = $is_first ? '<img src="bg/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="' . ahref('poll', 'move', array('where' => 'up', 'menu'=>$poll['pollid'], 'idx'=> $poll['idx'])) . '"><img src="bg/img/buttons/icon_arrow_up.png" alt="Move Up" title="Move Up" width="9" height="9" /></a>';
			$arrow_down = $is_last ? '<img src="bg/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="' . ahref('poll', 'move', array('where' => 'down', 'menu'=>$poll['pollid'], 'idx'=> $poll['idx'])) . '"><img src="bg/img/buttons/icon_arrow_down.png" alt="Move Down" title="Move Down" width="9" height="9" /></a>';
...
?>
					<div id="list" class="<?php echo $class;?> fix">
						<div class="check">
							<a href="javascript:chclick(<?php echo $poll['idx'];?>);"><img src="bg/img/buttons/icon_<?php echo $ch;?>visible.png" class="star" title="<?php echo a('tt.visibility');?>" id="img_<?php echo $poll['idx'];?>" style="width:9px;height:9px;" /></a>
						...
						<div class="action fix" style="padding-top:6px; width:120px;">
							<a href="<?php echo ahref('poll', 'edit', array('idx' => $poll['idx'], 'menu'=>$poll['pollid']));?>" title="<?php echo a('ql.edit');?>"><img src="bg/img/buttons/icon_edit.png" /></a>
							<a href="javascript:del(<?php echo $poll['id'];?>, '<?php echo $poll['answer'];?>');" title="<?php echo a('ql.delete');?>"><img src="bg/img/buttons/icon_delete.png" /></a>
						</div>									
					</div>		
<?php
		endforeach;
