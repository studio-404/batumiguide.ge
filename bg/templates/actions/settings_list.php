...
?>
					<div class="<?php echo $class;?> fix">
						...
						<div class="action2 fix">
							<a href="<?php echo ahref(array($route[0], 'edit', $setting['id']));?>" title="<?php echo a('ql.edit');?>"><img src="bg/img/buttons/icon_edit.png" /></a>
<?php if($_SESSION['auth']["class"] == '0' || $route[0]!='settings') { ?>
							<a href="javascript:del('<?php echo $setting['id'];?>', '<?php echo $setting['title'];?>');" title="<?php echo a('ql.delete');?>"><img src="bg/img/buttons/icon_delete.png" /></a>
<?php } ?>
						</div>									
