...
?>
					<div id="div<?php echo $user['id'] ?>" class="<?php echo $class;?> fix">
						...
						<div class="action fix" style="padding-top:6px;">
							...
							<a href="javascript:del(<?php echo $user['id'];?>, '<?php echo $user['email'];?>');"><img src="bg/img/buttons/icon_delete.png" class="star" title="<?php echo a('ql.delete');?>" /></a>
						</div>
...
?>
				<div id="bottom" class="fix">
					<ul id="page" class="fix left">
						<li><a href="<?php echo ahref(array($route[0], 'show'), array('start' => 0));?>"><img src="bg/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], 'show'), array('start' => $uc * ($j - 1)));?>"><img src="bg/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
...
?>
						<li><a href="<?php echo ahref(array($route[0], 'show'), array('start' => $uc * ($k - 1)));?>"><img src="bg/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], 'show'), array('start' => $uc * ($lastpage - 1)));?>"><img src="bg/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
					<a href="<?php echo ahref(array($route[0], 'add'));?>" class="button br" style="float: right"><?php echo a("newuser");?></a>
				</div>
			</div>
