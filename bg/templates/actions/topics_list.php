<?php defined('DIR') OR exit; ?>
		<div id="title" class="fix">
			<div class="icon"><img src="bg/img/buttons/_table.png" width="16" height="16" alt="" /></div>			
...
?>
					<div id="div<?php echo $topic['id'] ?>" class="<?php echo $class;?> fix">
						<div class="icon4"><img src="bg/img/buttons/_<?php echo $img;?>.png" width="16" height="16" alt="" /></div>									
						<div class="name4"><a href="<?php echo ahref(array($linktype, 'show', $topic["id"]));?>"><?php echo $ttl; ?>&nbsp;</a></div>									
						<div class="action2 fix">
                            <a href="<?php echo ahref(array($linktype, 'show', $topic["id"])) ?>" title="<?php echo a('ql.editcontent');?>"><img src="bg/img/buttons/icon_files_edit.png" /></a>
							<a href="<?php echo ahref(array($type, 'edit', $topic['id']));?>" title="<?php echo a('ql.edit');?>"><img src="bg/img/buttons/icon_edit.png" /></a>
<?php if($count["items"] < 1 && in_array($topic['type'], array('sitemap', 'bannergroups'))): ?>
							<a href="javascript:del('<?php echo $topic['id'];?>', '<?php echo $topic['title'];?>');" title="<?php echo a('ql.delete');?>"><img src="bg/img/buttons/icon_delete.png" /></a>
<?php else: ?>
							<a href="javascript:;"><img src="bg/img/buttons/icon_delete_inactive.png" /></a>
<?php endif; ?>
						</div>
