<?php defined('DIR') OR exit; ?>
		<div id="title" class="fix">
			<div class="icon"><img src="bg/img/buttons/_user.png" width="16" height="16" alt="" /></div>			
...
?>
					<div id="div<?php echo $user['id'] ?>" class="<?php echo $class;?> fix">
						<div class="check">
							<a href="javascript:chclick(<?php echo $user['id'];?>);"><img src="bg/img/buttons/icon_<?php echo $ch;?>visible.png" class="star" title="<?php echo a('tt.visibility');?>" id="img_<?php echo $user['id'];?>" style="width:9px;height:9px;" /></a>
						...
						<div class="action fix">
							<a href="<?php echo ahref(array($route[0], 'edit', $user['id']));?>"><img src="bg/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.editcontent');?>" /></a>
							<a href="javascript:del(<?php echo $user['id'];?>, '<?php echo $user['username'];?>');"><img src="bg/img/buttons/icon_delete.png" class="star" title="<?php echo a('ql.delete');?>" /></a>
						</div>
...
?>
				<div id="bottom" class="fix">
					<ul id="page" class="fix left">
						<li><a href="<?php echo ahref(array($route[0], ''), array('start' => 0));?>"><img src="bg/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], ''), array('start' => $uc * ($j - 1)));?>"><img src="bg/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
...
?>
						<li><a href="<?php echo ahref(array($route[0], ''), array('start' => $uc * ($k - 1)));?>"><img src="bg/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], ''), array('start' => $uc * ($lastpage - 1)));?>"><img src="bg/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
					<a href="<?php echo ahref(array($route[0], 'add'));?>" class="button br" style="float: right"><?php echo a("newuser");?></a>
				</div>					
			</div>		
