<?php defined('DIR') OR exit; ?>
		<div id="title" class="fix">
			<div class="icon"><img src="bg/img/buttons/_camera.png" width="16" height="16" alt="" /></div>
...
<?php
	...
	if(count($gallery) > 0) :
		foreach($gallery as $item) :
			$is_first = ($count == 1);
			$is_last = ($count >= $total);
			$arrow_up = $is_first ? '<img src="bg/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="javascript:pos(\'up\',\''.$item['id'].'\')"><img src="bg/img/buttons/icon_arrow_up.png" alt="Move Up" title="Move Up" width="9" height="9" /></a>';
			$arrow_down = $is_last ? '<img src="bg/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="javascript:pos(\'down\',\''.$item['id'].'\')"><img src="bg/img/buttons/icon_arrow_down.png" alt="Move Down" title="Move Down" width="9" height="9" /></a>';
...
?>
					<div id="div<?php echo $item['id'] ?>" class="<?php echo $class;?> fix">
						<div class="check">
							<a href="javascript:chclick(<?php echo $item['id'];?>);"><img src="bg/img/buttons/icon_<?php echo $ch;?>visible.png" class="star" title="<?php echo a('tt.visibility');?>" id="img_<?php echo $item['id'];?>" style="width:9px;height:9px;" /></a>
						...
						<div class="action fix" style="padding-top:6px; width:120px;">
							<a class="preview" rel="lightbox[<?php echo $item['id'];?>]" href="<?php echo $item["image1"];?>" title="<?php echo a('ql.preview');?>"><img src="bg/img/buttons/icon_preview.png" style="padding-right:1px;" /></a>
							<a href="<?php echo ahref(array($route[0], 'edit', $item['id']));?>" title="<?php echo a('ql.edit');?>"><img src="bg/img/buttons/icon_edit.png" /></a>
							<a href="javascript:del(<?php echo $item['id'];?>, '<?php echo $item['title'];?>');" title="<?php echo a('ql.delete');?>"><img src="bg/img/buttons/icon_delete.png" /></a>
						</div>
