...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo JAVASCRIPT ?>/gselect/css/style.css" />
        <script type="text/javascript" src="<?php echo JAVASCRIPT;?>/gselect/js/scripts.js"></script>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo JAVASCRIPT;?>/map/styles.css" />
		<!--[if lt IE 9]>
    ...
    <body>
        <div id="digital">
			...
			<!-- CMS Content -->
            <div id="preloader"><img src="bg/img/preloader.gif"  /></div>
        </div>
        <!-- Footer -->
        <div id="footer">
            <div class="part">
