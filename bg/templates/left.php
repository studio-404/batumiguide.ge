    ...
    <div id="left">
        ...
        ?>">
            <table width="190" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="tdf4_1"><img src="bg/modules/images/<?php echo $nav['icon'] ?>" width="16" height="16" alt="" /></td>
        ...
        <div>
            <table width="190" border="0" cellspacing="0" cellpadding="0">
                <?php foreach ($nav['children'] AS $child): ?>
                    <tr>
                        <td class="tdff_1"><img src="bg/modules/images/<?php echo $child['icon'] ?>" width="16" height="16" alt="" /></td>
